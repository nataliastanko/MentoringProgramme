...
class PersonController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        // $query = $em
        //     ->createQuery('SELECT a FROM Entity:Person a order by a.createdAt desc');
    ...
    public function showAction(Person $person)
    {
        ...
        // person answers
        $answers = $em->getRepository('Entity:Answer')->filterByPerson($person->getId());
     ...
     * @Method("GET")
     * @Template("AdminBundle:person/Export:answers.html.twig")
     */
    public function exportAnswersAction(Request $request, Person $person)
    {
        ...
        $html = $this->renderView(
            'AdminBundle:person/export:answers.html.twig',
            $dataToPdf
        );
    ...
    public function changeMentorAction(Request $request, Person $person)
    {
        ...
        $editForm = $this->createForm(
            'AdminBundle\Form\PersonChangeMentorType',
