...
class MentorController extends Controller
{
     ...
     * @Template("AdminBundle:mentor:_list.html.twig")
     */
    public function sortAction(Request $request)
    {
        $em = $this->getDoctrine()->getManager();
        $repo = $em->getRepository('Entity:Mentor');
    ...
    public function searchAction($page, Request $request)
    {
        ...
        $filterForm = $this->createForm('AdminBundle\Form\Filter\MentorSearch');
        ...
        if ($filterForm->isValid()) {
            ...
            $qb = $em->getRepository('Entity:Mentor')
    ...
    public function listReloadAction(Request $request, $id)
    {
        ...
        if ($id === 'hasNoEdition') {
            ...
            $edition = $em->getRepository('Entity:Edition')->findOneById($id);
     ...
     * )
     * @Method("GET")
     * @Template("AdminBundle:mentor:_sort.html.twig")
     */
    ...
    private function createSearchForm() {
        return $this->createForm(
            'AdminBundle\Form\Filter\MentorSearch',
            null,
            [
    ...
    {
        $mentor = new Mentor();
        $form = $this->createForm('AdminBundle\Form\MentorType', $mentor);
    ...
    public function showAction(Mentor $mentor)
    {
        ...
        // mentors answers
        $answers = $question = $em->getRepository('Entity:Answer')->filterByMentor($mentor->getId());
     ...
     * )
     * @Method("GET")
     * @Template("AdminBundle:person:_list.html.twig")
     */
     ...
     * )
     * @Method("GET")
     * @Template("AdminBundle:mentor/export:persons_answers.html.twig")
     */
    public function exportPersonsAnswersAction(Request $request, Mentor $mentor, Edition $edition)
    {
        ...
        $html = $this->renderView(
            'AdminBundle:mentor/export:persons_answers.html.twig',
            $dataToPdf
        );
    ...
    {
        $deleteForm = $this->createDeleteForm($mentor);
        $editForm = $this->createForm('AdminBundle\Form\MentorType', $mentor);
