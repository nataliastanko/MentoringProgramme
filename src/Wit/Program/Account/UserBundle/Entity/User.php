...
use Wit\Program\Account\UserBundle\Repository\UserRepository;
 ...
 * )
 * @ORM\Entity(repositoryClass="Wit\Program\Account\UserBundle\Repository\UserRepository")
 */
class User extends FosUser
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Wit\Program\CalendarBundle\Entity\Event", mappedBy="author", cascade={"persist"})
     **/
    protected $eventsCreated;

    /**
     * @ORM\OneToMany(targetEntity="Wit\Program\CalendarBundle\Entity\EventNote", mappedBy="author", cascade={"persist"})
     **/
     ...
     *
     * ORM\ManyToMany(
     *     targetEntity="Wit\Program\CalendarBundle\Entity\Event",
