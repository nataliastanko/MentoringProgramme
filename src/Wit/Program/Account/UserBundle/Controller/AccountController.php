...
namespace Wit\Program\Account\UserBundle\Controller;
...
class AccountController extends Controller
{
    ...
    public function accountAction(Request $request)
    {
        if ($this->get('security.authorization_checker')->isGranted('ROLE_ADMIN')) {
            return $this->forward(
                'WitProgramAccountUserBundle:Account:admin',
                [
                    [],
            ...
            return $this->forward(
                'WitProgramAccountMentorBundle:Account:mentor',
                [
                    [],
                    '_route' => $request->attributes->get('_route'),
                    '_route_params' => $request->attributes->get('_route_params')
            ...
            return $this->forward(
                'WitProgramAccountMenteeBundle:Account:mentee',
                [
                    [],
                    '_route' => $request->attributes->get('_route'),
                    '_route_params' => $request->attributes->get('_route_params')
    ...
    public function adminAction()
    {
        ...
        $mentorsWithoutAnyMentee = $em->getRepository('WitProgramAdminEditionBundle:Mentor')
            ->findMentorsWithoutMentees($edition->getId());
        // find mentors did not choose mentee in current edition
        $mentorsWithoutChosenMentee = $em->getRepository('WitProgramAdminEditionBundle:Mentor')
    ...
    //         'Wit\Program\Account\UserBundle\Form\ChangeLocaleType',
    //         null,
    //         [
