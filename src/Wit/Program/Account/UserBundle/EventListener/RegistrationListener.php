...
namespace Wit\Program\Account\UserBundle\EventListener;
...
/**
 * @TODO add form protection against brutal force register
 */
class RegistrationListener implements EventSubscriberInterface
{
    ...
    public function onRegistrationInitialize(GetResponseUserEvent $event)
    {
        ...
        $invitation = $this->em->getRepository('Wit\Program\Account\UserBundle\Entity\Invitation')
            ->findOneBy(
                [
                    'code' => $code,
                    'isAccepted' => true
    ...
    public function onRegistrationSuccess(FormEvent $event)
    {
        ...
        /** @var $user \Program\Account\UserBundle\Entity\Invitation */
        ...
        if ($role === Invitation::ROLE_MENTOR) {
            ...
            if ($mentor->findChosenPerson()) {
                ...
                if ($menteeInvitation && $menteeInvitation->getIsAccepted()) {
                    ...
                    $menteeUser = $this->em->getRepository('WitProgramAccountUserBundle:User')
            ...
            if ($mentorInvitation && $mentorInvitation->getIsAccepted()) {
                ...
                $mentorUser = $this->em->getRepository('WitProgramAccountUserBundle:User')
