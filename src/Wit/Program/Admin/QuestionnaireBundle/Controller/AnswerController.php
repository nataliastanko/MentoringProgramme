...
class AnswerController extends Controller
{
    ...
    public function indexAction($id, $page, Request $request)
    {
        ...
        $question = $em->getRepository('WitProgramAdminQuestionnaireBundle:Question')->findOneById($id);

        $query = $em
            ->createQuery('SELECT a FROM WitProgramAdminQuestionnaireBundle:Answer a WHERE a.question = :id')
            ->setParameter(':id', $id);
