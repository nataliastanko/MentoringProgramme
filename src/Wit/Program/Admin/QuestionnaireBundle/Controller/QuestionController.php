...
namespace Wit\Program\Admin\QuestionnaireBundle\Controller;
...
class QuestionController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Wit\Program\Admin\QuestionnaireBundle\Form\QuestionType', $question);
    ...
    {
        // $deleteForm = $this->createDeleteForm($question);
        $editForm = $this->createForm('Wit\Program\Admin\QuestionnaireBundle\Form\QuestionType', $question);
