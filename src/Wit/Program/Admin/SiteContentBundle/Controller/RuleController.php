...
use Wit\Program\Admin\SiteContentBundle\Entity\Rule;
...
class RuleController extends Controller
{
    ...
    public function sortAction(Request $request)
    {
        ...
        $repo = $em->getRepository('WitProgramAdminSiteContentBundle:Rule');
    ...
    {
        $rule = new Rule();
        $form = $this->createForm('Wit\Program\Admin\SiteContentBundle\Form\RuleType', $rule);
    ...
    {
        $deleteForm = $this->createDeleteForm($rule);
        $editForm = $this->createForm('Wit\Program\Admin\SiteContentBundle\Form\RuleType', $rule);
