...
use Wit\Program\Admin\EditionBundle\Entity\Partner;
...
class PartnerController extends Controller
{
    ...
    public function sortAction(Request $request)
    {
        ...
        $repo = $em->getRepository('WitProgramAdminEditionBundle:Partner');
    ...
    public function indexAction()
    {
        $partners = $this->getDoctrine()->getManager()
            ->getRepository('WitProgramAdminEditionBundle:Partner')
            ->getAll();
    ...
    {
        $partner = new Partner();
        $form = $this->createForm('Wit\Program\Admin\EditionBundle\Form\PartnerType', $partner);
    ...
    {
        $deleteForm = $this->createDeleteForm($partner);
        $editForm = $this->createForm('Wit\Program\Admin\EditionBundle\Form\PartnerType', $partner);
