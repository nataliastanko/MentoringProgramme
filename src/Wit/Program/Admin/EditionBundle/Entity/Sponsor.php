 ...
 * @UniqueEntity(
 *     fields="name",
 *     message="name.taken", groups={"settings"}
 * )
 * @UniqueEntity(
 *     fields="email",
...
class Sponsor
{
     ...
     *     groups={"settings"}
     * )
     * @Vich\UploadableField(mapping="sponsor_photo", fileNameProperty="photoName")
     *
     * @var File
     */
    private $photoFile;
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Wit\Program\Admin\EditionBundle\Entity\Edition", inversedBy="sponsors")
     * @ORM\JoinTable(name="sponsors_editions")
     **/
    private $editions;
