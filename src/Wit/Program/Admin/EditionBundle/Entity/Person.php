 ...
 * )
 * @ORM\Entity(repositoryClass="Wit\Program\Admin\EditionBundle\Repository\PersonRepository")
 */
class Person
{
    /**
     ...
     * )
     * @ORM\ManyToOne(targetEntity="Wit\Program\Admin\EditionBundle\Entity\Mentor", inversedBy="persons")
     ...
     *
     * @ORM\ManyToOne(
     *     targetEntity="Wit\Program\Admin\EditionBundle\Entity\Edition",
     *     inversedBy="persons"
     * )
     ...
     * @ORM\OneToOne(targetEntity="Wit\Program\Account\UserBundle\Entity\Invitation", inversedBy="person")
