 ...
 *    }
 * )
 * @ORM\Entity(repositoryClass="Wit\Program\Admin\EditionBundle\Repository\MentorMultifunctionalRepository")
 */
class Mentor
{
    use Translatable;
    ...
    /**
     * @ORM\OneToMany(targetEntity="Wit\Program\Admin\EditionBundle\Entity\Person", mappedBy="mentor")
     **/
    private $persons;

    /**
     * @ORM\ManyToMany(targetEntity="Wit\Program\Admin\EditionBundle\Entity\Edition", inversedBy="mentors")
    ...
    /**
     * @ORM\OneToMany(
     *     targetEntity="Wit\Program\Admin\QuestionnaireBundle\Entity\Answer",
     *     mappedBy="mentor",
     *     cascade={"all"}
     * )
     **/
     ...
     * @ORM\OneToOne(targetEntity="Wit\Program\Account\UserBundle\Entity\Invitation", inversedBy="mentor")
